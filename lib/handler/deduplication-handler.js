...
class DeduplicationHandler {
  ...
  /**
   * @type {Buffer[] | string[] | Record<string, string | string[]> | null}
   */
  #rawHeaders = null
  ...
  addWaitingHandler (handler) {
    ...
    try {
      ...
      if (this.#responseStarted) {
        waitingController.rawHeaders = this.#rawHeaders
  ...
  onResponseStart (controller, statusCode, headers, statusMessage) {
    ...
    this.#rawHeaders = controller?.rawHeaders ?? null
  ...
  onResponseEnd (controller, trailers) {
    ...
    for (const waitingHandler of this.#waitingHandlers) {
      ...
      waitingHandler.controller.rawTrailers = controller?.rawTrailers ?? null
